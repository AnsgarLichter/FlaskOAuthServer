...
# __name__ can not be used here because dots are not allowed and the __name__ is website.routes
...
@bp.route('/api/me')
@require_oauth('profile') #Required scope can be entered as parameter instead of None
def api_me():
